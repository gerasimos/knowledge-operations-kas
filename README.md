...
[![Version](https://img.shields.io/badge/version-v0.1.0-green.svg)](https://github.com/gerasimos/knowledge-operations-kas/releases/tag/v0.1.0)
...
```bibtex
@misc{xydas2026knowledgeoperations,
  title        = {Knowledge Operations: A Capability Model for AI Systems},
...
© 2026 Gerasimos Xydas.

The paper and all derived artifacts are licensed under [Creative Commons Attribution 4.0 International (CC BY 4.0)](LICENSE). You may share, adapt, and build on the work for any purpose, including commercially, as long as you provide attribution.

## Acknowledgements

The framework is a practitioner synthesis, not an empirical derivation; its inputs are the academic literature cited in the paper, the evaluation criteria used by major analyst frameworks for adjacent categories, the failure-mode taxonomies surfaced in agentic-RAG surveys and applied-agent guidance, and recurring patterns observed in enterprise RAG deployments. The §14 "Limitations and Future Work" section makes the scope and sensitivity of these inputs explicit. The work is offered as a thinking framework, to be revised as evidence accumulates.

---

**Author**: Gerasimos Xydas · [ORCID 0009-0003-7817-5791](https://orcid.org/0009-0003-7817-5791) · [LinkedIn](https://www.linkedin.com/in/gerasimosxydas/)
